    ...
    <div class ="main">
        ...
        <div class="signup">
            ...
            <input type="text" name="Lname"  placeholder="Last name">
                ...
                <input type="email" name="Email" placeholder="Mark1234@xxx.com">
                <br>
                <br>
                ...
                <input type="text" name="PassConfirm" placeholder="Write your password again">
                <br><br><br>

                <input type="radio" name="Learner" value="Learner">Learner
                <input type="radio" name="Learner" value="Admin">Admin
