...
function addData($conn,$productname, $productprice, $productid,$userId)
{
   $sql="INSERT INTO orders (Product_Id,Product_Name,Product_Price,U_ID)
   VALUES ('$productid','$productname','$productprice',$userId)";
